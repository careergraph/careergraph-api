...
public class InterviewRoomController {
        ...
        private InterviewRoomResponse toResponse(InterviewRoom room) {
                List<InterviewRoomResponse.RoomParticipantResponse> participants = Optional
                                .ofNullable(room.getParticipants())
        ...
        private InterviewRoomResponse.RoomParticipantResponse toParticipantResponse(RoomParticipant p) {
                ...
                String candidateEmail = Optional.ofNullable(p.getCandidate())
                                .map(c -> c.getAccount())
                                .map(a -> a.getEmail())
                                .orElse(null);
