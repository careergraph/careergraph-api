...
- Ứng viên sẽ upload CV(kiểm tra luồng là BE là lắng nghe event sẽ truncate intent CV) trường hợp là ứng viên sẽ bật CV này là dùng để cho HR tìm kiếm. Là sẽ đồng bộ lắng nghe sự kiện là ứng viên sẽ bật CV nào cho phép tìm kiếm, nếu xóa thì remove dữ liệu đi
- Hãy thực hiện sao cho chuẩn enterprise production là sẽ không bị loãng giữa CV và tieu chí tìm việc của ưng viên 
- Và đồng bộ ứng viên khi data ban đầu có, chưa đồng bộ vào elasticsearch. 

- Hãy đọc src và thực hiệ sau đó cập nhật thay đổi về nghiệp vụ viết ra file md để sau này tôi có thể xem lại và lưu vào folder này careergraph-api\docs\improve_seach. 
